...
controller('seleccionProveedorController', function($scope, $filter, $timeout, $interval, growl, $controller, $q, $window, cotizacionesService, rutasService, $compile, solicitud, proveedores) {
