...
controller('esperaClienteCotizacionesController', function($scope, $filter, $timeout, $interval, growl, $controller, $q, $window, cotizacionesService, rutasService, $compile, proveedoresDefault, otrosProveedores, solicitud) {
