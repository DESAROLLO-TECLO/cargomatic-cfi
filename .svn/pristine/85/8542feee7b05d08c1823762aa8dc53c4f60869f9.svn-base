...
angular.module('angucomplete', [] )
    ...
    return {
        ...
        template: '<div class="angucomplete-holder">'+
        		  	...
        		  	'<div class="angucomplete-searching" ng-show="!searching && (!results || results.length == 0)">{{nocoincide}}</div>'+
        		  	...
        		  	'</div><div class="angucomplete-title" ng-if="matchClass" ng-bind-html="result.title"></div><div class="angucomplete-title" ng-if="!matchClass">{{ result.title }}</div>'+
