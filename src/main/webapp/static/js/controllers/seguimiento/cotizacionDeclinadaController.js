...
controller('cotizacionDeclinadaController', function($scope, $filter, $timeout, $interval, growl, $controller, $q, $window, cotizacionesService, rutasService, $compile, proveedoresDefault, otrosProveedores, solicitud) {
	...
	$scope.addDeclined($scope.proveedoresDefault[1], 1);
	$scope.addDeclined($scope.proveedoresDefault[2], 2);
